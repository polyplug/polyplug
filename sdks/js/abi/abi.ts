...
export const ABI_HOST_CONTRACT_NOT_FOUND: number = 100;

export const ABI_HOST_CONTRACT_VERSION_MISMATCH: number = 101;

export const ABI_HOST_CONTRACT_CALL_FAILED: number = 102;

...
# Build the mdBook docs site strictly — broken links / missing pages fail (the
# committed book.toml has create-missing = false).
docs-check:
    @echo "=== Building docs (mdbook, strict) ==="
    mdbook build

# Verify the committed SDK ABI mirrors match the build script's output. The
# mirrors under sdks/*/abi are generated by crates/polyplug_abi/build/generate.rs
# and must never be hand-edited (Rule 10). Regenerate, then assert nothing moved.
verify-abi-mirrors:

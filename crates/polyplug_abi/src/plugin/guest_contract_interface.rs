...
mod tests {
    ...
    use crate::plugin::guest_contract_interface::GuestContractInterface;
    ...
    fn layout_plugin_interface() {
        ...
        // Total: 40 bytes
        assert_eq!(size_of::<GuestContractInterface>(), 40);
        ...
        assert_eq!(offset_of!(GuestContractInterface, dispatch), 24);
    }
}
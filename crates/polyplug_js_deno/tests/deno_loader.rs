...
// ── Generated host caller pattern with factory method ───────────────────────────

#[test]
fn generated_host_caller_factory_pattern_works() {
    // Test the generated JavaScript host caller pattern with factory method.
    // This verifies the pattern used by polyplugc for js-deno targets.
    ...
    // Bundle defines a host caller class following the generated pattern and tests it.
    // Uses private field syntax (#guard) as generated by js_deno.rs.
    let bundle: String = format!(
        r#"

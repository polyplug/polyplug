...
fn generate_csharp_layout_tests(sized_structs: &[(&str, usize)]) -> String {
    ...
    // for; these offsets are frozen ABI (unload_bundle @136, log @144,
    // create_guest_instance @152, destroy_guest_instance @160, reserved @176;
    // RuntimeConfig log @24, log_user_data @32, log_max_level @40).

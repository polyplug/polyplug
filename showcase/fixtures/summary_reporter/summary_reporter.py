# showcase/plugins/summary_reporter/summary_reporter.py
#
...
# Path hierarchy: showcase/plugins/summary_reporter -> showcase/plugins -> showcase -> repo root
...
# DataRecord — mirrors showcase/abi_types.md (frozen ABI)

...
function decoder_fn0_abi_wrapper(impl: any, args_ptr: number, out_ptr: number, arena_ptr: number, bridge: any): number {
...
export function setDecoderFactory(factory: (bridge: any, hostLo: number, hostHi: number) => { fn0: (input: { ptr_lo: number; ptr_hi: number; len: number }) => string }): void {

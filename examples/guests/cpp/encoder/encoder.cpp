// rust_encoder — C++ native plugin implementing pipeline.Encoder v1.
...
class Encoder : public PipelineEncoderPlugin {
public:
    StringView encode(StringView data) override {
        emit_trace("[cpp_encoder] encode called");
        // Transform | to ,
        // For simplicity, return input - real impl would transform
        return data;
    }
};

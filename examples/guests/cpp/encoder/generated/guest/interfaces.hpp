...
// null, or it throws.
static void ENCODER_create_instance(VmLoaderData loader_data, const HostApi* host, const void* args, GuestContractInstance* out_instance) noexcept {
...
static void ENCODER_destroy_instance(VmLoaderData loader_data, const HostApi* host, GuestContractInstance instance) noexcept {
    (void)loader_data;  // Native-dispatch contracts ignore the VM loader handle.
...
inline void encoder_encode_abi(GuestContractInstance instance, const void* args, void* out, AbiError* out_err) noexcept {
    if (instance.data == nullptr) {

...
public:
    Resident() : registration_{InProcessBundleMetadata{StringView{reinterpret_cast<const uint8_t*>("cpp_validator"), 13U}, Version{1U, 0U, 0U}, SupportedLanguage::Cpp}, nullptr, 0U, nullptr, 0U} {
...
InProcessBundle create_in_process_bundle(ValidatorFactory validator_factory) {
    InProcessBundle bundle;
    bundle.add_validator(std::move(validator_factory));
    return bundle;
}

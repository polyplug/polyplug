...
// null, or it throws.
static void DECODER_create_instance(void* adapter_context, VmLoaderData loader_data, const HostApi* host, const void* args, GuestContractInstance* out_instance) noexcept {
...
static void DECODER_destroy_instance(void* adapter_context, VmLoaderData loader_data, const HostApi* host, GuestContractInstance instance) noexcept {
    (void)adapter_context;
    (void)loader_data;  // Native-dispatch contracts ignore the VM loader handle.
...
inline void decoder_decode_abi(void* adapter_context, GuestContractInstance instance, const void* args, void* out, AbiError* out_err) noexcept {
    (void)adapter_context;
    if (instance.data == nullptr) {

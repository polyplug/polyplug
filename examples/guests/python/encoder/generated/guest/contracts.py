...
class ENCODERPipelineEncoderGuestContract:
    def encode(self, input: StringView) -> StringView:
        raise NotImplementedError

_encoder_IMPL: ENCODERPipelineEncoderGuestContract | None = None
def set_encoder_impl(impl: ENCODERPipelineEncoderGuestContract) -> None:
...
def encoder_encode_abi(instance: _GuestContractInstance, args_ptr: ctypes.c_void_p, out_ptr: ctypes.c_void_p) -> _AbiError:
    ...
    impl: ENCODERPipelineEncoderGuestContract | None = _encoder_IMPL
    if impl is None:

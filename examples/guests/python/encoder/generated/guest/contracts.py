...
ENCODER_PLUGIN_NAME_C: ctypes.c_void_p = ctypes.cast(ctypes.c_char_p(ENCODER_PLUGIN_NAME_BYTES), ctypes.c_void_p)
ENCODER_CONTRACT_NAME_C: ctypes.c_void_p = ctypes.cast(ctypes.c_char_p(ENCODER_CONTRACT_NAME_BYTES), ctypes.c_void_p)
...
def encoder_encode_abi(args_ptr: int, out_ptr: int) -> _AbiError:
...
ENCODER_encoder_encode_abi_CFUNC = _DISPATCH_FN_CTYPE(_wrap_sret(encoder_encode_abi))

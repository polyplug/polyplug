...
use super::vtables::RUST_ENCODER_CONTRACT_ID;
use super::vtables::RUST_ENCODER_VTABLE;
...
pub unsafe extern "C" fn polyplug_init(
    ...
    let desc_RUST_ENCODER: PluginDescriptor = PluginDescriptor {
        name: StringView { ptr: b"rust_encoder".as_ptr(), len: 12_usize },
    ...
    let err_RUST_ENCODER: AbiError = unsafe {
        (reg.register_plugin)(registrar, &desc_RUST_ENCODER as *const PluginDescriptor, &RUST_ENCODER_VTABLE as *const PluginVTable)
    };
    if err_RUST_ENCODER.code != ABI_OK {
        return err_RUST_ENCODER;
    }

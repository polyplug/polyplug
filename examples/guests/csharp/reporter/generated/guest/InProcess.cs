...
public static class InProcessBundleFactory {
    public static InProcessBundle CreateInProcessBundle(
        Func<IntPtr, IDataReporterGuestContract> reporter_data_reporterFactory
    ) {
        var resident = new Resident(
            reporter_data_reporterFactory
        );
    ...
    private sealed class Resident : IDisposable {
        ...
        private readonly byte[] _manifest = [];
        ...
        internal Resident(
            ...
            _interfaces = [
                ReporterInterfaces.CreateInProcessInterface(reporter_data_reporterFactory),
            ];
            _strings = [
                System.Text.Encoding.UTF8.GetBytes("reporter"),
                System.Text.Encoding.UTF8.GetBytes("data.Reporter@1"),
            ];
        ...
        public void Dispose() {
            if (_disposed) return;
            _disposed = true;
            ReporterInterfaces.ReleaseInProcessInterface(_interfaces[0]);

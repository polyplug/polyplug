...
function polyplug_init(rt_ctx, host_ptr, ctx_ptr)
    ...
    local err_TRANSFORMER = host.register_plugin(rt_ctx, TRANSFORMER_DESCRIPTOR, TRANSFORMER_VTABLE)
    if err_TRANSFORMER.code ~= ABI_OK then
        return err_TRANSFORMER.code
    end

...
function M._register_ENCODER(registrations)
    local functions = {}
    ...
    registrations["pipeline.Encoder"] = {
        contract_version = 1,
        plugin_name = "encoder",
...
function polyplug_init(host_ptr, ctx_ptr)
    ...
    if ENCODER_FACTORY == nil then
        return {}, { code = polyplug_guest.AbiErrorCode.Generic, message = "set_encoder_factory(...) was not called at import time" }
    end
    M._register_ENCODER(registrations)

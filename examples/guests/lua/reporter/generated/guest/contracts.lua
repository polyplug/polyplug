...
function M._register_REPORTER(registrations)
    local functions = {}
...
function polyplug_init(host_ptr, ctx_ptr)
    ...
    if REPORTER_FACTORY == nil then
        return {}, { code = polyplug_guest.AbiErrorCode.Generic, message = "set_reporter_factory(...) was not called at import time" }
    end
    M._register_REPORTER(registrations)

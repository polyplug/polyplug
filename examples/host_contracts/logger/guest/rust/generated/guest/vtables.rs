...
/// Plugin: worker
/// Contract ID constant -- pre-computed FNV-1a of "example.worker@1".
pub const WORKER_CONTRACT_ID: u64 = 0xE1C66C3C27F331A4;
...
extern "C" fn worker_do_work_abi(args: *const (), out: *mut ()) -> AbiError {
...
pub static WORKER_VTABLE: PluginInterface = PluginInterface {
    ...
    dispatch: PluginDispatch {
        native: NativeDispatch {
            functions: WORKER_FNS.as_ptr() as *const *const (),
        },
    },
};

...
pub unsafe extern "C" fn polyplug_init(
    ...
    let desc_WORKER: PluginDescriptor = PluginDescriptor {
        name: StringView { ptr: b"worker".as_ptr(), len: 6_usize },
        contract_name: StringView { ptr: b"example.worker@1".as_ptr(), len: 16_usize },
        version_major: 1_u32,
        version_minor: 0_u32,
        version_patch: 0_u32,
    };
    ...
    let err_WORKER: AbiError = unsafe {
        (host.register_plugin)(rt_ctx, &desc_WORKER as *const PluginDescriptor, &WORKER_VTABLE as *const PluginInterface)
    };

...
public static class VTableFactories {
...
private static AbiError host_logger_log_thunk(IntPtr implPtr, IntPtr argsPtr, IntPtr outPtr) {
    try {
        ...
        impl.Log(message);
        _ = outPtr;
        return new AbiError { Code = AbiConstants.ABI_OK };
    } catch (Exception ex) {
...
/// </remarks>
public static HostContractVTable CreateHostLoggerVTable<T>(T impl) where T: IHostLogger {
    // Store implementation reference in a static field
    s_HostLogger_impl = impl;

    var functions = new IntPtr[1] {
...
/// </remarks>
public static HostContractVTable CreateHostLoggerVTableVm(
    IntPtr bridgeData,

...
- **Zero/Minimal-Overhead FFI** — Direct function pointer dispatch with near-zero overhead for native languages (~2.3 ns/call measured), minimal overhead for VM-based languages

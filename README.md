...
- **Cross-compiling Linux to Windows MSVC?** Follow the [canonical loader build guide](docs/CROSS_COMPILATION.md).
- **Maintaining polyplug?** See the [development workflow](docs/WORKFLOW.md).

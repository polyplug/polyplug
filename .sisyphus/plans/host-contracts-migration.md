...
- [ ] 5. Regenerate Rust code with enhanced polyplugc

  **What to do**:
  - Regenerate guest: `polyplugc generate --bundle ...`
  - Regenerate host: `polyplugc generate --api ...`
  - Verify `host/vtable_factories.rs` created
  ...
  **QA Scenarios**:
  ```
  Scenario: Code regenerated
    Tool: bash
    Steps:
      1. ls examples/hosts/rust/src/generated/host/vtable_factories.rs
    Expected: File exists
    Evidence: .sisyphus/evidence/task-5-regenerated.txt
  ```

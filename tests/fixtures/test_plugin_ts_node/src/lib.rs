//! Test plugin for polyplug ts-node integration tests.
//!
//! This is a hand-written test fixture (not generated by polyplugc).
//! It implements the "test.add" contract: add(a: u32, b: u32) -> u32.
//! Used by the ts-node / JavaScript integration test suite.
//!
